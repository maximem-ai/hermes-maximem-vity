...
Installed from PyPI:
    ...
    hermes-maximem-vity install      # copies plugin into ~/.hermes/plugins/maximem_vity/ + activates it
...
auto-discovers the provider — then sets ``memory.provider: maximem_vity`` for you
